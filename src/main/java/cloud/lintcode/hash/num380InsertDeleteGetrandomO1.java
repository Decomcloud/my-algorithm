...
// 
// 
// Related Topics 设计 数组 哈希表 数学 随机化 👍 563 👎 0

public class num380InsertDeleteGetrandomO1 {
    public static void main(String[] args) {
        //Solution solution = new num380InsertDeleteGetrandomO1().new Solution();
    }
    ...
    class RandomizedSet {
        ...
        // 如果不是最后一个元素, 那么取出来要删除元素的下标和最后一个元素的下标, 在nums和map中交换它们
        // 然后移除掉nums的最后一个元素和map中需要删除元素的对应关系
