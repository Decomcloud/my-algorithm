...
public class num110BalancedBinaryTree_divideConquerSpecialSign {
    public static void main(String[] args) {
        Solution solution = new num110BalancedBinaryTree_divideConquerSpecialSign().new Solution();
    }
