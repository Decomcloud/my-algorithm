...
public class num109ConvertSortedListToBinarySearchTree {
    public static void main(String[] args) {
        Solution solution = new num109ConvertSortedListToBinarySearchTree().new Solution();
    }
 ...
 */
    ...
    class Solution {
        ...
        public TreeNode buildTree(ListNode left, ListNode right) {
            ...
            ListNode root = getMedian(left, right);
            TreeNode rootTreeNode = new TreeNode(root.val);
            rootTreeNode.left = buildTree(left, root);
            rootTreeNode.right = buildTree(root.next, right);
            return rootTreeNode;
        }
