...
public class num160IntersectionOfTwoLinkedLists_updateValue {
    public static void main(String[] args) {
        Solution solution = new num160IntersectionOfTwoLinkedLists_updateValue().new Solution();
    }
//leetcode submit region begin(Prohibit modification and deletion)
    ...
    public class Solution {
        ...
        private void recovery(ListNode headA, List<Integer> values) {
            ListNode recovery = headA;
